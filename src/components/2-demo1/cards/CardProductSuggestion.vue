    ...
    <div class="my-2 px-2">
        ...
        <div class="card__product">
            ...
            <div class="flex flex-col gap-2 items-center justify-center w-4/12">
                ...
                />
                <button :data-modal-target="'default-modal-sug-'+product.id" :data-modal-toggle="'default-modal-sug-'+product.id" class="block text-white bg-primary-200 hover:bg-primary-300 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-1 mx-auto text-center dark:bg-primary-200  dark:focus:ring-primary-800" type="button">
                    Ver Mas
                </button>
            </div>
...
<style scoped>
    ...
    .card__product-descriptions-tag{
        @apply block whitespace-nowrap  bg-primary-300 text-primary-800 text-xs font-medium my-2 me-2 px-2.5 py-0.5 rounded;
    }
