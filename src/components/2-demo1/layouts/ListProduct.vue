            ...
            <div class="relative m-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white px-4 pt-5 pb-10 rounded-lg shadow ">
                    ...
                    <div class="w-full flex justify-between items-center">
                        ...
                        <button class=" bg-primary-200 text-primary-800 text-xs font-medium my-2 me-2 px-3 py-2 rounded"  @click="apiList.clearList">Vaciar lista</button>
                    ...
                    <div v-for="product in apiList.ListProduct" :key="product.id">
                        ...
                        <div class="flex items-center justify-between gap-1 my-2">
                            ...
                            <div class="flex items-center gap-1">
                                <button class="block whitespace-nowrap  bg-primary-200 text-primary-800 text-sm font-medium my-2 px-2.5 py-0.5 w-6 h-6 rounded " @click="apiList.lessAmount(product.id)">-</button>
                                ...
                                <button class="block whitespace-nowrap  bg-primary-200 text-primary-800 text-sm font-medium my-2 px-2.5 py-0.5 w-6 h-6 rounded " @click="apiList.moreAmount(product.id)">+</button>
                            </div>
                        </div>
